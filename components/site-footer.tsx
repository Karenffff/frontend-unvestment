        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          <div className="mb-4">
            ...
            <p className="mb-4">
              ...
              and transparent investment plans.
            </p>
          ...
          <div>
            <h3 className="mb-4 text-sm font-semibold tracking-wider text-white uppercase">Platform</h3>
            <ul className="space-y-2">
              <li>
                <Link href="/invest" className="hover:text-amber-500">
                  Investment Plans
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/deposit" className="hover:text-amber-500">
                  Deposit
                </Link>
              </li>
              <li>
                <Link href="/withdraw" className="hover:text-amber-500">
                  Withdraw
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/compliance" className="hover:text-amber-500">
                  Compliance
                </Link>
              </li>
              <li>
                <Link href="/security" className="hover:text-amber-500">
                  Security
                </Link>
              </li>
            </ul>
